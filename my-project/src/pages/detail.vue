    ...
    <div class="wrapper">
      <div class="container clearfix">
        ...
        <div class="content">
          ...
          <div class="item-price">{{product.price}}元<span class="del">4999元</span></div>
          <div class="line"></div>
          <div class="item-addr">
            <i class="icon-loc"></i>
...
export default{
  ...
  methods:{
    getProductInfo(){
      this.$axios.get('http://mock.shtodream.cn/mock/5fa8fc178e13766542114da6/mimal/products').then((res)=>{
        this.product = res.data.data;
      })
    },
    addCart(){
      this.$axios.post('http://mock.shtodream.cn/mock/5fa8fc178e13766542114da6/mimal/carts',{
        productId:this.id,
        selected: true
      }).then((res={cartProductVoList:0})=>{
        this.$store.dispatch('saveCartCount',res.data.data.cartTotalQuantity);
